...
export default function MoveForm({ house }: { house: string }) {
  ...
  const harborsPerNode: Record<number, number[]> = {
    ...
    4: [],
    5: [
      2, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44, 46, 47, 49, 50, 52,
    ],
    6: [],
    7: [
      2, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44, 46, 47, 49, 50, 52,
    ...
    23: [],
    24: [
      2, 5, 7, 11, 14, 17, 21, 31, 35, 38, 41, 43, 44, 46, 47, 49, 50, 52,
    ],
    25: [],
    26: [],
    27: [
    ...
    40: [],
    41: [
      2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 43, 44, 46, 47, 49, 50,
    ],
    42: [],
    43: [
      2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 46, 47, 49, 50, 52,
    ],
    44: [
      2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 46, 47, 49, 50, 52,
    ],
    45: [],
    46: [
      2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44, 49, 50, 52,
    ],
    47: [
      2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44, 49, 50, 52,
    ],
    48: [],
    49: [
      2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44, 46, 47, 52,
    ],
    50: [
      2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44, 46, 47, 52,
    ],
