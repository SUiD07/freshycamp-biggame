...
export default function MoveForm({ house }: { house: string }) {
  ...
  for (const node of frontendNodes) {
    if (!backendNodes.includes(node)) {
      problems.push(`⚠️ Node ${node} ไม่มีอยู่ในข้อมูลล่าสุด กรุณากดทั้งปุ่ม"รีเฟรชข้อมูลแผนที่"และ"รีเฟรชฟอร์มกรอกข้อมูล"`);
    }
  }
  ...
  for (const node of backendNodes) {
    if (!frontendNodes.includes(node)) {
      problems.push(`⚠️ มี Node ใหม่ (${node}) ในข้อมูลล่าสุด กรุณากดทั้งปุ่ม"รีเฟรชข้อมูลแผนที่"และ"รีเฟรชฟอร์มกรอกข้อมูล"`);
    }
  }
  ...
  const allowedDestinations: Record<number, number[]> = {
    1: [1, 2, 3, 40],
    2: [
      2, 1, 3, 39, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44, 46,
      47, 49, 50, 52,
    ],
    3: [3, 1, 2, 4, 5],
    4: [4, 3, 5, 6],
    5: [
      5, 3, 4, 6, 7, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    6: [6, 4, 5, 7, 8],
    7: [
      7, 5, 6, 8, 9, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    8: [8, 6, 7, 9],
    9: [9, 7, 8, 10],
    10: [10, 9, 11, 12],
    11: [
      11, 10, 12, 13, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    12: [12, 10, 11, 13],
    13: [13, 11, 12, 14, 15],
    14: [
      14, 13, 15, 16, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    15: [15, 13, 14, 16],
    16: [16, 14, 15, 17, 18],
    17: [
      17, 16, 18, 19, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    18: [18, 16, 17, 19],
    19: [19, 17, 18, 20],
    20: [20, 19, 21, 22],
    21: [
      21, 20, 22, 23, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    22: [22, 20, 21, 23],
    23: [23, 21, 22, 24, 25],
    24: [
      24, 23, 25, 26, 27, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43,
      44, 46, 47, 49, 50, 52,
    ],
    25: [25, 23, 24, 26],
    26: [26, 24, 25, 27, 28],
    27: [
      27, 24, 26, 28, 29, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43,
      44, 46, 47, 49, 50, 52,
    ],
    28: [28, 26, 27, 29],
    29: [29, 27, 28, 30, 31],
    30: [30, 29, 31, 32],
    31: [
      31, 29, 30, 32, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    32: [32, 30, 31, 33],
    33: [33, 32, 34, 35],
    34: [34, 33, 35, 36],
    35: [
      35, 33, 34, 36, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    36: [36, 34, 35, 37, 38],
    37: [37, 36, 38, 39],
    38: [
      38, 36, 37, 39, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    39: [39, 2, 37, 38, 40],
    40: [40, 1, 39],
    41: [
      41, 42, 52, 53, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    42: [42, 41, 43, 59],
    43: [
      43, 42, 44, 54, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    44: [
      44, 43, 45, 54, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    45: [45, 44, 46, 60],
    46: [
    ...
    51: [51, 50, 52, 57],
    52: [
      52, 41, 51, 53, 2, 5, 7, 11, 14, 17, 21, 24, 27, 31, 35, 38, 41, 43, 44,
      46, 47, 49, 50, 52,
    ],
    53: [53, 41, 52, 59],
    54: [54, 43, 44, 59, 60],
